defmodule Issues.TableFormatter do
  ...
  @doc """
  Take a list of row data, where each row is a Map. and a list of
  headers. Prints a table to STDOUT of the data from each row
  identfied by each header. That is, each header identifies a column,
  and those columns are extracted and printed from the row.0
  ...
  of columns, return a containing lists of the data in
  ...
  a column, return a list contaning the maximum width of each column
  ## Example
  ...
  hyphens, with + signs where the vertical bar between the coumns goes.
